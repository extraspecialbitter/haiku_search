...
db = MySQLdb.connect("localhost","user","********","archive" )
...
# insert line into table
    if date_row:
        ...
        my_text = my_text + newline + "<br>"

# print "%s" %my_text
# print "%s" %date_written

# SQL query to INSERT a line into the selected table 
cursor.execute('INSERT into ' + table_name + '(my_text, date_written) values (%s, %s)', (my_text, date_written))
