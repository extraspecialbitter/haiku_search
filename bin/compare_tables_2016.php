...
$search_query = "SELECT * FROM archive_2016 WHERE haiku_text NOT IN (SELECT haiku_text FROM archive_2016_from_html)";
...
$search_query = "SELECT * FROM archive_2016_from_html WHERE haiku_text NOT IN (SELECT haiku_text FROM archive_2016)";
